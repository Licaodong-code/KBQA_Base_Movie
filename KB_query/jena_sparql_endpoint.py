...
class JenaFuseki:
    #建立初始化连接
    def __init__(self, endpoint_url='http://localhost:3030/kg_demo_movie/sparql'):
...
#    limit 10
        """
    result = fuseki.get_sparql_result(my_query) #获取查询值
    fuseki.print_result_to_string(result) #打印查询结果
